...
export interface TrailRatedProps {
...
export interface HighlightProps {
  ...
  setShowStickerFooter: React.Dispatch<React.SetStateAction<boolean>>;
}
...
export interface StickerFooterProps {
  showStickerFooter: boolean;
}

export interface IYoutubeBanner {
  title?: string;
  description?: string;
}

export interface IYoutubeVideoModal {
