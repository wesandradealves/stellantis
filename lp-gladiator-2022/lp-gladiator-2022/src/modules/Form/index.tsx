...
const Form = ({ setShowFeedback }: FormProps) => {
  ...
  const initialValues = {
    ...
    origin: "site",
    productGroup: "Vendas",
    referer: "https://gladiator.jeep.com.br/agende/",
    retUrl: "https://gladiator.jeep.com.br/agende/",
    county: "",
    cidade: "",
    uf: "",
    cpf: "",
          ...
          <div className={styles.containerCheckbox}>
            <div
              ...
              <label htmlFor="accept">
                <span>
                Ao fornecer seus dados pessoais acima, você autoriza que a Jeep compartilhe seus dados com nossas instituições financeiras parceiras, para viabilizar o envio de uma proposta de financiamento do veículo de seu interesse.
Saiba como essas instituições financeiras tratam seus dados pessoais na Política de Privacidade disponível em seus sites.
Seus dados pessoais poderão ser utilizados pela Jeep e pela concessionária selecionada para fins de envio de comunicações de marketing de produtos e serviços relacionados à Jeep.
Para mais detalhes sobre como desativar o recebimento de comunicações de marketing e outras informações sobre como a Jeep trata seus dados pessoais, acesse a Política de Privacidade (https://www.jeep.com.br/politica-de-privacidade.html).
