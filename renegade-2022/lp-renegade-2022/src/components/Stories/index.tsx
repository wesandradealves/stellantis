...
import { Arrow, Chevron, LoadingFlag, Pointer } from '../SvgComponents';
      ...
      <div className={styles.bar}>
        {items.map((story, index) => {
          ...
          return (
            ...
            >
              <div
                className={scssStyles([styles.barItem, hasGone ? styles.hasGone : ''])}
              >
                <AnimatePresence>
                  {active && (
                    <div
      ...
      <div ref={wrapperRef} className={styles.wrapper}>
        ...
        <ScrollToAnchor
          ...
          className={scssStyles([
            styles.scrollCta,
            items[currentIndex].scrollCtaOrientation ===
              'vertical'
              ? styles.scrollCtaVertical
              : styles.scrollCtaHorizontal
          ])}
          pageSubsection="jeep-renegade"
          ...
          {items.map((story, index) => {
            ...
            if (story.background?.style?.backgroundSize) {
              style['backgroundSize'] =
                story.background?.style?.backgroundSize;
            }
        ...
        <AnimatePresence>
          {!!items[currentIndex]?.showNext &&
            items[currentIndex + 1]?.title && (
              ...
              >
                {items[currentIndex + 1].title}
                <Arrow title={items[currentIndex + 1].title} />
              </motion.button>
            )}
        </AnimatePresence>
      </div>
